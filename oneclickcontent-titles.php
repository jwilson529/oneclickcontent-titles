 ...
 * Description:       Free AI title assistant for WordPress from the go-to bring-your-own-key AI plugin line. Use your own OpenAI, Google Gemini, or OpenRouter API key.
 * Version:           2.2.0
 ...
 */
define( 'OCC_TITLES_VERSION', '2.2.0' );
